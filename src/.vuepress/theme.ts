...
const DivElement= `<div>168网校前端开发</div>`


export default hopeTheme({
  hostname: "https://mister-hope.github.io",
  /** 主题色配置（https://theme-hope.vuejs.press/zh/guide/interface/theme-color.html#%E8%AE%BE%E7%BD%AE%E9%BB%98%E8%AE%A4%E4%B8%BB%E9%A2%98%E8%89%B2） */
  themeColor: {
    blue: "#2196f3",
    red: "#f26d6d",
    green: "#3eaf7c",
   ...
   * https://theme-hope.vuejs.press/zh/guide/layout/navbar.html#git-%E4%BB%93%E5%BA%93%E5%92%8C%E7%BC%96%E8%BE%91%E9%93%BE%E6%8E%A5
   * 
   */ 
  ...
  /**
   * 博主基本信息
   * https://theme-hope.vuejs.press/zh/guide/blog/blogger.html
   */
  blog: {
    name: 'SOBER',
    ...
    medias: {
      ...
      // MrHope: ["https://mrhope.site", MR_HOPE_AVATAR], // 自定义图标
    },
  },
  ...
  locales: {
    ...
    "/": {
      ...
      //   name: 'SOBER & spoony-z',
      //   description: "一个前端开发者",
      //   intro: "/zh/intro.html", // 点击头像或姓名跳转个人介绍页
      // },
  ...
  encrypt: {
    ...
    /** 局部加密 */
    config: {
      "/learning-notes/java/primary/总结.html": ["961711"],
      "/guide/2023计划表.html": ["961711"]
    },
  },
