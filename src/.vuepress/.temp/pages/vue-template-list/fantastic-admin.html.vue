<template><div><h1 id="fantastic-admin" tabindex="-1"><a class="header-anchor" href="#fantastic-admin" aria-hidden="true">#</a> fantastic-admin</h1>
<!-- more -->
<p align="center">
...
<ul>
<li>丰富的布局与主题，覆盖市面上各种中后台应用场景，兼容PC、平板和移动端</li>
<li>提供系统配置文件，轻松实现个性化定制</li>
<li>精心设计的动效，让每一处的动画都干净利落</li>
<li>根据路由配置自动生成导航栏</li>
<li>基于文件系统的路由</li>
<li>支持全方位权限验证</li>
<li>内置多级路由最佳缓存方案</li>
<li>轻松实现国际化多语言适配</li>
<li>提供接近于浏览器原生标签栏操作体验的标签页功能</li>
</ul>
<h2 id="分支说明" tabindex="-1"><a class="header-anchor" href="#分支说明" aria-hidden="true">#</a> 分支说明</h2>
<ul>
<li><code v-pre>master</code> Vue3 版本框架源码分支，不含示例代码，可直接用于实际开发</li>
<li><code v-pre>example</code> Vue3 版本演示源码分支，同线上演示站，包含大量示例，可用于参考学习</li>
<li><code v-pre>vue2</code> Vue2 版本框架源码分支，不含示例代码，可直接用于实际开发（停止维护）</li>
<li><code v-pre>vue2-example</code> Vue2 版本演示源码分支，包含大量示例，可用于参考学习（停止维护）</li>
</ul>
...
<h2 id="支持" tabindex="-1"><a class="header-anchor" href="#支持" aria-hidden="true">#</a> 支持</h2>
<p>如果觉得 Fantastic-admin 这个框架不错，或者已经在使用了，希望你可以在 <strong>Github</strong> 或者 <strong>Gitee(码云)</strong> 帮我点个 ⭐ ，这将对我是极大的鼓励。</p>
<figure><a href="https://github.com/hooray/fantastic-admin/stargazers" target="_blank" rel="noopener noreferrer"><img src="https://img.shields.io/github/stars/hooray/fantastic-admin?style=social" alt="star" tabindex="0" loading="lazy"><ExternalLinkIcon/></a><figcaption>star</figcaption></figure>
<figure><a href="https://gitee.com/hooray/fantastic-admin/stargazers" target="_blank" rel="noopener noreferrer"><img src="https://gitee.com/hooray/fantastic-admin/badge/star.svg?theme=dark" alt="star" tabindex="0" loading="lazy"><ExternalLinkIcon/></a><figcaption>star</figcaption></figure>
